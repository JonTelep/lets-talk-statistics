...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Clean Minimal Theme - Neutral palette with single accent
        neutral: {
          50: 'rgb(250 250 250)',
          100: 'rgb(244 244 245)',
          200: 'rgb(228 228 231)',
        ...
        accent: {
          ...
          300: '#7dd3fc',
          400: '#38bdf8',
          500: '#0ea5e9',  // Primary accent - bright blue
          600: '#0284c7',
          700: '#0369a1',
          800: '#075985',
          900: '#0c4a6e',
      ...
      boxShadow: {
        ...
        'minimal-xl': '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)',
      },
      animation: {
