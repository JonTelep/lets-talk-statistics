          ...
          <div className="mb-8">
            ...
            <div className="mb-8">
              <SocialShare 
                ...
                description={`Track congressional stock trades in real-time. ${stats?.traders_count || 'Members of Congress'} politicians tracked, thousands of tickers, all from official STOCK Act disclosures.`}
