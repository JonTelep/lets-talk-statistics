          ...
          <div className="mb-8">
            ...
            <div className="mb-8">
              <SocialShare 
                ...
                description={`Track congressional stock trades in real-time. ${stats?.traders_count || 'Members of Congress'} politicians, ${stats?.total_trades || 'thousands'} of trades, all from official STOCK Act disclosures.`}
